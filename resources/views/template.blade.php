    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/penyimpanan') }}" class="brand-link">
                <img src="{{ asset('adminlte/dist/img/morin-logo.png') }}" alt="moRin Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Morin</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('adminlte/dist/img/woman.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="https://1drv.ms/b/s!ApioQiHuoxzikvFottbYMDV8hC3n6g?e=QmhopD" class="nav-link"
                                target="_blank">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy;2022 <a href="https://padangpanjangkota.bps.go.id">BPS Kota Padang
                    Panjang</a>.</strong>
            All rights reserved.
